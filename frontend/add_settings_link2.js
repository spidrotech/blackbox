const fs = require('fs');
const path = 'C:/workspace/blackbox/frontend/src/app/quotes/[id]/edit/page.tsx';

let content = fs.readFileSync(path, 'utf8');

const regex = /<CardTitle className="text-base">\s*Apercu PDF\s*<\/CardTitle>/i;
...
if (regex.test(content)) {
  ...
  console.log("Regex not found in Edit page.");
}

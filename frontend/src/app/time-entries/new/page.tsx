...
export default function NewTimeEntryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await timeEntryService.create(formData);
      if (response.success) {
  ...
  return (
    <MainLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Nouvelle saisie de temps</h1>
          <p className="text-gray-500">Enregistrer du temps de travail</p>
        </div>
